...
identity rename. The physical local-folder move is still blocked by a Windows process lock. The
next work item remains planner-controlled and is prepared in `TASK.md`.
