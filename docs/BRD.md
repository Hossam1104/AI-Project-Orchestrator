...
rebaseline. APO-20 subsequently completed the active repository and local-root identity rename to
AI Project Orchestrator. Technical identifiers containing `AIUsageMonitor` remain unchanged and
...
1. Product identity is AI Project Orchestrator (APO); APO-20 renamed the active repository and
   local root while preserving technical identifiers for a later controlled migration.
